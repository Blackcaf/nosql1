...
public class EventController {
  ...
  public EventView create(@RequestBody Event e) {
    return service.create(e);
  }

  @GetMapping("/{id}")
  public EventView open(@PathVariable String id) {
  ...
  public EventView update(
      @PathVariable String id, @RequestHeader("If-Match") long revision, @RequestBody Event e) {

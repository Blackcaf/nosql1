...
public class DraftController {
  ...
  public DraftView create(@RequestBody DraftRequest r, Principal p) {
    return service.create(r, p.getName());
  }

  @GetMapping
  public List<OrderDraft> all() {
    return service.all();
  }

  @GetMapping("/{id}")
  public DraftView get(@PathVariable String id) {
    return service.get(id);
  }

  @PostMapping("/{id}/extend")
  public Map<String, Long> extend(@PathVariable String id) {
    return Map.of("ttl", service.extend(id));
  }

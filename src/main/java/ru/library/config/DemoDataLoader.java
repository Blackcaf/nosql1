...
public class DemoDataLoader {
  ...
  public DemoDataLoader(EventService events, AppProperties props) {
    this.events = events;
    this.props = props;
  }
  ...
  public void load() {
    ...
    events.create(
        new Event(
            null,
            "Встреча с автором: Евгений Водолазкин",
            EventType.AUTHOR_MEETING,
    ...
    events.create(
        new Event(
            null,
            "Лекция «История книгопечатания»",
            EventType.LECTURE,
            LocalDateTime.now().plusDays(3).withHour(17).withMinute(30),
            "Малый зал",
            25,
            25,
            BigDecimal.ZERO,
    ...
    events.create(
        new Event(
            null,
            "Читательский клуб: Достоевский",
            EventType.READING_CLUB,
